...
const Form3Pdf = ({ formInput, individualOwners, companyOwners, signatures, currentYear, currentMonth, currentDay, expirationYear, expirationMonth, expirationDay }) =>{
const price = "8500000"
            ...
            <Page style={styles.page}>
                <View style={styles.top_container}>
                    ...
                    <View style={styles.form3_heading_gp}>
                        <Text style={styles.form3_heading}>出售香港住宅物業用的地產代理協議</Text>
                        <Text style={styles.form3_heading_remark}>表格3</Text>
                    </View>
                    ...
                    <View style={styles.form3_gp_inline}>
                        ...
                        {signatures.map((signature, index)=>(
                            ...
                            <Text>本人/我們:{individualOwners && individualOwners.map((owner, index) => `${owner.ownerName}${index < individualOwners.length - 1 ? ', ' : ''}`)} & {companyOwners && companyOwners.map((companyOwner, index) => `${companyOwner.ownerName}${index < companyOwners.length - 1 ? ', ' : ''}`)}
                        ...
                        <View style={styles.form3_term_gp}>
                            ...
                            <View style={styles.form3_gp_inline}>
                                ...
                                <View style={styles.form3_gp_incolumn}>
                                    ...
                                    <Text>x (8) 同意於賣方與一名買方訂立具約束力的買賣協議之前收取物業資料表格 包括賣方的陳述</Text>
                                </View>
                            </View>
                        </View>
                    </View>
